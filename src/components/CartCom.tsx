    ...
    <div className="container mx-auto mt-12 p-6">
      ...
      {cartItems.length === 0 ? (
        ...
        <div>
            ...
            {cartItems.map((item) => (
              <div key={item.id} className="flex flex-col sm:flex-row items-center justify-between bg-white p-4 rounded-lg shadow-md">
                ...
                <button
                  ...
                  className="text-red-500 hover:text-red-700 font-semibold mt-4 sm:mt-0 sm:ml-4"
                >
          ...
          {/* Cart Total */}
          <div className="mt-8 flex flex-col sm:flex-row justify-between items-center bg-gray-100 p-4 rounded-lg">
          ...
          <div className="mt-6 flex justify-end">
            <button className="px-6 py-2 bg-primaryColor text-white rounded-lg shadow-md hover:bg-primaryColorDark transition duration-300 w-full sm:w-auto">
              Proceed to Checkout
            </button>
          </div>
        </div>
